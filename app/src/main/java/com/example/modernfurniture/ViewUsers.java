...
public class ViewUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
           // SharedPreferences shr= PreferenceManager.getDefaultSharedPreferences(cart.this);
            ...
            url = url + "ViewUser.php";
            // url = url + "pass=" + URLEncoder.encode(pass)    + "&";
            gettrans.execute(url);

        }catch(Exception e){
            Toast.makeText(ViewUsers.this, "", Toast.LENGTH_SHORT).show();
        }
    ...
    private class GetData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ViewUsers.this, null, "Please Wait...");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (arraylength == 0) {
                    Toast.makeText(ViewUsers.this, "Invalid Username Password", Toast.LENGTH_LONG);
                } else {
                    ...
                    for (int i = 0; i < jsonMainNode.length(); i++) {
                        ...
                        contact[i] = "CNumber " + jsonChildNode.optString("CNumber");
                        email[i] = "Email " + jsonChildNode.optString("Email");
                ...
                LevelAdapter2 lv1 = new LevelAdapter2(ViewUsers.this, name, contact, email);
                lst1.setAdapter(lv1);

            } catch (Exception e) {
                Toast.makeText(ViewUsers.this, " ", Toast.LENGTH_LONG).show();
            }
